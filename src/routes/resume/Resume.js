            ...
            <div className="contact-container">
              ...
              <div className="contact">
                ...
                <div className="contact-item">
                  ...
                  <span className="contact-item-text">
                    <a href="tel:+2347030000000">+2347037491437</a>
                  </span>
                </div>
                <div className="contact-item">
                  <span className="contact-item-icon">
            ...
            <div className="experience">
              ...
              <div className="experience-container">
                <div className="experience-item">
                  <div className="experience-item-name">Software Engineer</div>
                  ...
                  <div className="experience-item-responsibilities">
                    <ul>
                      ...
                      <li>
                        Developed and maintained backend services using Python,
                        Django, and Flask.
                      </li>
                      <li>
                        Developed and maintained RESTful APIs using Python and
                        Flask
                      </li>
                      <li>
                        Prepared technical proposals and documentation for
                        clients.
                      </li>
                      <li>
                        Provided technical support to clients and other team
                        members.
                      </li>
                      <li>
                      ...
                      <li>
                        Prepared system design and architecture for applications.
                      </li>
                      <li>Analysed and documented business requirements.</li>
                      <li>Extracted and analysed data from databases.</li>
                      <li>
                        Wrote scripts to automate tasks and improve efficiency.
                      </li>
                    </ul>
                  </div>
